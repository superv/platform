...
class PolymorphicFieldTest extends ResourceTestCase
{
    ...
    {
        $this->assertTrue(Resource::exists('testing.contacts_sms'));
        $this->assertTrue(Resource::exists('testing.contacts_email'));
    ...
    function __config()
    {
        $selectTypeField = sv_resource('testing.contacts')->getField('type');
