...
class ResourceIndexTest extends ResourceTestCase
{
    ...
    function test__index_table_config()
    {
        ...
        foreach ($fields as $key => $field) {
            ...
            $this->assertEquals('sv/res/testing.users/{entry.id}/view', $rowActions[1]['props']['url']);
    ...
    {
        Resource::extend('testing.posts')->with(function (Resource $resource) {
    ...
    function test__filters_apply_on_relations()
    {
        ...
        $group = sv_resource('testing.groups')->create(['title' => 'Ottomans']);
