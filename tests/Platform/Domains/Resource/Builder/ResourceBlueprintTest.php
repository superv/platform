...
class ResourceBlueprintTest extends ResourceTestCase
{
    ...
    {
        $usersBlueprint = Builder::blueprint('testing.roles',
            function (Blueprint $resource) {
                $resource->belongsToMany('testing.actions', 'actions')
        ...
        $actionsRelation = $usersBlueprint->getRelation('actions');
        $this->assertEquals([
        ...
        $actionsField = $usersBlueprint->getField('actions');
