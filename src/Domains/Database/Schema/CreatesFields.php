...
trait CreatesFields
{
    ...
    {
        return $this->string($name)->fieldType('email')->rules(['email:rfc']);
    }
    ...
    {
        $this->nullableBelongsTo('sv.platform.users', 'created_by')->hideOnForms();
...
//        $this->unsignedBigInteger('sort_order')->default(0);
    ...
    {
        $this->nullableBelongsTo('sv.platform.users', 'updated_by')->hideOnForms();
