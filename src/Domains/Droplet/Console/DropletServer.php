...
use SuperV\Platform\Domains\Droplet\Command\QueueServerFeature;
...
class DropletServer extends Command
{
    use DispatchesJobs;
    
    protected $signature = 'droplet:server {droplet} {feature} {--server= : }';
    
    protected $description = 'Runs droplet feature on server';
    ...
    public function handle(ServerRepository $servers)
        {
            ...
            $this->dispatch(new QueueServerFeature($drop,  $this->argument('feature')));
